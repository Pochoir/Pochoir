 ...
 * ============================================================================
 */
#ifndef AUTO_TUNING_SAWZOID2_HPP 
#define AUTO_TUNING_SAWZOID2_HPP 
...
inline void auto_tune<N_RANK>::symbolic_modified_space_cut_interior(int t0,
 ...
 */
template <int N_RANK> template <typename F>
inline void auto_tune<N_RANK>::symbolic_modified_space_cut_boundary(int t0,
		int t1, grid_info<N_RANK> const & grid, unsigned long parent_index, 
		F const & f, int * num_zoids)
{
    queue_info *l_father;
...
template <int N_RANK> template <typename F>
inline void auto_tune<N_RANK>::symbolic_modified_space_time_cut_interior(
...
template <int N_RANK> template <typename F>
inline void auto_tune<N_RANK>::symbolic_modified_space_time_cut_boundary(
		int t0, int t1,	grid_info<N_RANK> const & grid, 
		unsigned long parent_index, int child_index, F const & f)
{
    const int lt = t1 - t0;
...
//#ifndef NDEBUG
#if 0
inline void auto_tune<N_RANK>::homogeneous_modified_space_cut_interior(
				int t0, int t1, grid_info<N_RANK> const & grid, 
...
// modified space cuts. 
template <int N_RANK> template <typename F>
inline void auto_tune<N_RANK>::heterogeneous_modified_space_cut_interior(
				int t0, int t1, grid_info<N_RANK> const & grid, 
				zoid_type * projection_zoid, F const & f)
				//zoid_type * projection_zoid, F const & f, int * num_zoids)
{
...
//#ifndef NDEBUG
#if 0
inline void auto_tune<N_RANK>::homogeneous_modified_space_cut_boundary(
	int t0, int t1,	grid_info<N_RANK> const & grid, 
	zoid_type * projection_zoid, F const & f)
	//zoid_type * projection_zoid, F const & f, int * num_zoids)
#else
...
inline void auto_tune<N_RANK>::heterogeneous_modified_space_cut_boundary(
	int t0, int t1,	grid_info<N_RANK> const & grid, 
